...
<!--                                         <span class="section">Personal Info</span> -->
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input value = "<%=Faci.getNombres()%>" type="text" id="nombre" name="nombre" required="required" class="form-control ">
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input value = "<%=Faci.getTelefono()%>" type="text" id="telefono" name="telefono" required="required" class="form-control ">
											</div>
										</div>
											...
											<div class="col-md-6 col-sm-6 ">
												<input value = "<%=Faci.getEmail()%>" type="text" id="email" name="email" required="required" class="form-control ">
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input value = "<%=Faci.getGrado_academico()%>" type="text" id="grado_academico" name="grado_academico" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
