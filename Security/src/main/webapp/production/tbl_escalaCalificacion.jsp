...
%>
  <head>
    ...
    <title>Inscripciones | Evaluación </title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="Inicio.jsp" class="site_title"> <i class="fa-solid fa-book"></i><span>GestiÃ³n Docente</span></a>
            </div>
                    ...
                    <%
                      ...
                      <thead>
                        <tr>
                          ...
                          <th>DescripciÃ³n <a onclick="eliminarcolumna(2)"><i class="fa-solid fa-circle-minus"></i></a></th>
        ...
        $('#tbl_calificacion').DataTable( {
        	buttons: [  
        				
		        		{
			        		extend: 'csv',
							text: 'CSV',
							title: 'Escalas de calificaciÃ³n registradas',
