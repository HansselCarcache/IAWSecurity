        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="Inicio.jsp" class="site_title"><i class="fa fa-paw"></i> <span>Gestión Docente</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa-solid fa-landmark"></i> Oferta <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li><a><i class="fa-solid fa-graduation-cap"></i> Docentes <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li><a><i class="fa-solid fa-school"></i> Capacitaciones <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Inicio <small>Some examples to get you started</small></h3>
              </div>
