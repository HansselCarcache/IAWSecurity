...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="entidades.Tbl_modalidad, datos.*, java.util.*"%>
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="tbl_facultad" class="table table-striped table-bordered" style="width:100%">
                    
                    <%
                      		
                      		ArrayList<Tbl_modalidad> listaMod = new ArrayList<Tbl_modalidad>();
                      		Dt_modalidad dtmod = new Dt_modalidad();
                      		listaMod =  dtmod.listaModalidadesActivas();
                      ...
                      <thead>
                        <tr>
                          ...
                          <th>Nombre Modalidad <a onclick="eliminarcolumna(0)"><i class="fa-solid fa-circle-minus"></i></a></th>
                      ...
                      <tbody>
                    	 <%
	                      	for(Tbl_modalidad tmod :listaMod){
	                      		String estado= "";
	                      		if(tmod.getEstado()!=3){
	                      			estado= "Activo";
	                      		}
