                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                       <form action="../Sl_rptTipoCalificacion" method="post" novalidate>
...
<!--                                                 <input class="form-control" class='optional' name="occupation" data-validate-length-range="5,15" type="text" /></div> -->
												<%						                      	
							                      	ArrayList<Tbl_escalaCalificacion> ListaEscCalificacion = new ArrayList<Tbl_escalaCalificacion>();
						                      		Dt_escalacalificacion dtec= new Dt_escalacalificacion();
						                      		ListaEscCalificacion = dtec.listaEscalaActivo();
								                 %>
								                 <select required class="form-control js-example-basic-single" name="pTipoCal" id="pTipoCal" > <!-- Cambiar el id y name -->
												  <option value="0">Seleccione...</option>
												  <% 
												  	for(Tbl_escalaCalificacion tof :ListaEscCalificacion){
												  %>
												  <option value="<%=tof.getId_escala()%>"><%=tof.getTipo_calificacion()%></option>
												  <%
												  	}
												  %>
												</select>
...
<!--                                                 <input class="form-control" class='optional' name="occupation" data-validate-length-range="5,15" type="text" /></div> -->
												<%						                      	
								                 ...
								                 %>
								                 <select class="form-control js-example-basic-single" name="pconvTC" id="pconvTC" > <!-- Cambiar el id y name -->
												  <option value="0">Seleccione...</option>
												  <% 
