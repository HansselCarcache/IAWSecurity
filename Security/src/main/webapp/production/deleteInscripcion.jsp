...
<!--                                         <span class="section">Personal Info</span> -->
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
												<input type="text" id="facultad" name="facultad" class="form-control" readonly="readonly" placeholder="Facultad">
											</div>
                                        </div>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                            <input type="text" id="departamento" name="departamento" class="form-control" readonly="readonly" placeholder="Departamento">
											</div>
                                        </div>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                            <input type="text" id="carrera" name="carrera" class="form-control" readonly="readonly" placeholder="ID Carrera">
											</div>
                                        </div>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                            <input type="text" id="capacitacion" name="capacitacion" class="form-control" readonly="readonly" placeholder="Capacitación">
											</div>
                                        </div>
