...
<head>
    ...
    <title>Capacitación | Modificar </title>
                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Modificación de capacitaciones </h2>
...
<!--                                         <span class="section">Personal Info</span> -->
								...
								<select id="id_modalidad" required="required" class="form-control ">
