                ...
                <div class="">
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Modificar escala de Calificacion Detalle</h3>
                        </div>
...
<!--                                         <span class="section">Personal Info</span> -->
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="desc" name="desc" required="required" value="<%=escala.getDescripcion() %>"class="form-control "readonly>
											</div>
										</div>
														...
														<tbody>
															...
															<tr>
																...
																<td>
											                          	...
											                          	&nbsp;&nbsp;
											                          	<a href="readEscalaCalificacionDet.jsp?id=?m=<%=det.getId_escala()%>&d=<%=det.getId_det_escalaCalificacion()%>">
