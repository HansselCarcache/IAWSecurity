...
<head>
	...
	<title>Registro | Sistema de gestión docente</title>
            				...
            				<div class="x_content">
            					<form id="frmDocente" name="frmDocente" action="Sl_login" method="post" onsubmit="toSubmit(event)">
									...
									<div class="field item form-group">
										<label class="col-form-label col-md-3 col-sm-3 label-align" >Contraseña nueva: <span class="required">*</span>
										</label>
									...
									<div class="ln_solid">
                                        <div class="form-group">
                                            <div class="col-md-6 offset-md-3">
                                                <button onclick="comprobarClave()" class="btn btn-primary">Reestablecer contraseña</button>
