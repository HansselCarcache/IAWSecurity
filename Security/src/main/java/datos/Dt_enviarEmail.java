...
public class Dt_enviarEmail {
	...
	//ATRIBUTOS
		...
		private static final String SMTP_AUTH_USER = "hanssel.eclipse@gmail.com";
		...
		String linkHR2 = "http://localhost:8080/Security/nuevaPwd.jsp";
		...
		public boolean enviarEmailVerificacion(String usuario, String correo, String codigo) throws MessagingException{
		 ...
		 //METODO QUE ENVIA EL EMAIL DE VERIFICACION
		public boolean enviarEmailContraseña(String usuario, String correo) throws MessagingException{
		   ...
		   Authenticator auth = new SMTPAuthenticator();
			 ...
			 session.setDebug(debug);
		      ...
		      //Cuerpo del correo  
		        String myMsg = "<strong>PROCESO DE VERIFICACION DEL CORREO ELECTRONICO INSTITUCIONAL </strong><br><br>";
		      	myMsg += "Estimado usuario, usted ha solicitado reestablecer su contrase&ntilde;a del Sistema ...,";
		      	myMsg += "a continuaci&oacute;n se detallan los datos enviados: <br><br>";
		      	myMsg += "<strong><u> DATOS DEL USUARIO/ESTUDIANTE </u></strong> <br><br>";
		      	myMsg += "<strong>USUARIO / CARNET: </strong> "+usuario+"<br>";
		      	myMsg += "<strong>Correo electr&oacute;nico: </strong> "+email_solicitante+"<br>";
		      	myMsg += "Enlace de verificaci&oacute;n: "  + linkHR2 + "?user="+ usuario + "&email="+email_solicitante+"<br>";
		      	myMsg += "Aseg&uacute;rate de hacer clic en el enlace de reestablecimiento de contrase&ntilde;a que has recibido para que puedas recuperar tu contrase&ntilde;a, en caso de no haber solicitado una cuenta, por favor hacer caso omiso al presente correo.";
		      	myMsg += "<br>----------------------------------------------------------<br>";
		      	myMsg += "Administrador del Sistema<br>";
		      	myMsg += "Celular: +505 8888-8888 <br>";
		      	myMsg += "CARGO<br>";
